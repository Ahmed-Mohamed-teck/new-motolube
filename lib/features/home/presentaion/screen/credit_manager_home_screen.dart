...
import '../../../technician/domain/entity/technician_appointment_entity.dart';
import '../../../technician/presentation/screen/technician_appointment_details_screen.dart';
...
class CreditManagerHomeScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<CreditManagerHomeScreen> createState() =>
      _CreditManagerHomeScreenState();
}

class _CreditManagerHomeScreenState
    extends ConsumerState<CreditManagerHomeScreen> {
  static const int _fallbackNeedApprovalStatusId = 10;
  late final int _needApprovalStatusId = _resolveNeedApprovalStatusId();
  ...
  Future<void> _fetchAppointments(String userId) async {
    ...
    await ref
        ...
        .loadAppointments(
          ...
          fromDate: _fromDate,
          toDate: _toDate,
          statusId: _needApprovalStatusId.toString(),
        );
  }
  ...
  int _resolveNeedApprovalStatusId() {
    final resolved = getStatusIdFromStatusName('needApproval');
    if (resolved == 0) return _fallbackNeedApprovalStatusId;
    return resolved;
  }
...
class _ApprovalFilterBar extends StatelessWidget {
