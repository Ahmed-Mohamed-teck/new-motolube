      ...
      child: ListView(
        ...
        children: [
            ...
            child: SizedBox(
              ...
              child: HomeCarOutlinedCard(
                ...
                onBook: () async {
                  ...
                  print("index is => ${ref.read(currentNavBottomIndexProvider)}");// Navigate to booking screen
                },
                heroTag: 'car-1-hero',
          ...
          SizedBox(
            width: 200,
            child: HomeCarOutlinedCard(
                    imageUrl: 'https://images.pexels.com/photos/210017/pexels-photo-210017.jpeg',
